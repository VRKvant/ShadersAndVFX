Shader "Myshader02/fresnelBlinking"
{
    ...
    SubShader
    {
        ...
        Pass {
            ...
            float4 frag (Interpolators i) : SV_Target  {    
                ...
                //making ligh and its color works
               ...
               // float3 R = reflect(-L,N);//phong
                ...
                //view vector - postition of the current fragment and pos of camera
                specularLight  = pow(specularLight,specularExponent);//specular exponent
                specularLight *=_LightColor0.xyz;

                //float fresnel = 1-dot(V,N);
                float fresnel = (1-dot(V,N))*(cos(_Time.y*4))*0.5;
               // float fresnel = step(0.6,1 - dot (V,N)); //outline
              //  return fresnel;
